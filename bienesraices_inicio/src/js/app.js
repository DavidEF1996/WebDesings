...
function eventListeners(){
    ...
    mobileMenu.addEventListener('click', (e)=>{ //le damos una accion de click y cuando esto pase llamamos a la funcion navegacionResponsive();
...
function navegacionResponsive(){
    ...
    if ( navegacion.classList.contains('mostrar')){ //si navegacion contiene la etiqueta de mostrar la va a remover, esto para que oculte el menu
